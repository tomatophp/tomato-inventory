        ...
        <div style="margin-top: -20px;">
            @php
                $options = "";
                 ...
                 $price = \TomatoPHP\TomatoEcommerce\Services\Cart\ProductsServices::getProductPrice($item->item_id, $item->options??[]);
                 $product = \TomatoPHP\TomatoProducts\Models\Product::find($item->item_id);
